 ...
 * @returns 
 */
export const getComicGridImage = function ({ url, x = 0, y = 0, width = 0, height = 0 }: options, handles: HandleType[] = ["white-transparent"]): Promise<string> {
